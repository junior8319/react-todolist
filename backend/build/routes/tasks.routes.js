...
const validateUpdateTask_middleware_1 = __importDefault(require("../middlewares/validateUpdateTask.middleware"));
...
tasksRouter.put('/tasks/:id', validateToken_middleware_1.default, validateUpdateTask_middleware_1.default, Tasks_controller_1.default.updateTask, error_middleware_1.default.handleErrors);
